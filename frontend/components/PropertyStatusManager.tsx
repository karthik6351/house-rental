...
const STATUS_CONFIG: Record<PropertyStatus, { label: string; colorClass: string; dotClass: string }> = {
    ...
    under_negotiation: { label: 'Negotiating', colorClass: 'badge-warning', dotClass: 'bg-amber-500' },
    maintenance: { label: 'Maintenance', colorClass: 'badge-danger', dotClass: 'bg-red-500' },
